...
public class ZoomableLineChart extends Application {
	...
	ObservableList<String> dates1 = FXCollections.observableArrayList();
	...
	public void start(Stage primaryStage) {
		 ...
		 String startdate = "";
			try {
				...
				String sCurrentLine;			 
				reader = new BufferedReader(new FileReader("E:\\finalyear\\LineChartData2.csv"));
				while ((sCurrentLine = reader.readLine()) != null) {
						
					String arr[] = sCurrentLine.split(",");
					if(dates1.indexOf(arr[0]) < 0)
					{
						dates1.add(arr[0]);
						startdate =  arr[0].substring(6, 8) + "-" + arr[0].substring(4, 6) + "-" + arr[0].substring(0, 4);
						dates.add(startdate);
	...
	private void updateChart()
	{
		...
		controls2.getChildren().addAll(backButton);
		//root.setCenter(chartContainer);
		root.setTop(controls2);
	...
	private LineChart<Number, Number> createChart() {
		...
		try {
			...
			while ((sCurrentLine = reader.readLine()) != null) {
				...
				String arr[] = sCurrentLine.split(",");
				String startdate =  arr[0].substring(6, 8) + "-" + arr[0].substring(4, 6) + "-" + arr[0].substring(0, 4);
